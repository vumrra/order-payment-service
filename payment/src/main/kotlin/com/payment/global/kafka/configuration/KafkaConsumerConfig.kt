package com.payment.global.kafka.configuration

import com.payment.global.kafka.consumer.ProductReservedConsumer
...
class KafkaConsumerConfig(
    ...
    @Bean
    fun productReservedEventListenerContainerFactory(listener: ProductReservedConsumer): ConcurrentKafkaListenerContainerFactory<String, String> =
