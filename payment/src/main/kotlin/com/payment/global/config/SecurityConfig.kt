...
import com.payment.global.filter.AuthenticationFilter
import com.payment.global.handler.CustomAccessDeniedHandler
import com.payment.global.handler.CustomAuthenticationEntryPointHandler
...
class SecurityConfig(
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        http.authorizeHttpRequests { httpRequests ->
            // health check
            httpRequests.requestMatchers(HttpMethod.GET, "/payment/health").permitAll()
